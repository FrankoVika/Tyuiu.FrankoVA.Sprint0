using Tyuiu.FrankoVA.Sprint0.Task7.V0.Lib;
namespace Tyuiu.FrankoVA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Написать консольную программу на C#, которая суммиует значение двух     *");
